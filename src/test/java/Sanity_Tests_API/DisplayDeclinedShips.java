...
public class DisplayDeclinedShips extends PTRAC_TestBase{
	static String api;
	Response response;
	...
	DisplayDeclinedShips() throws EncryptedDocumentException, InvalidFormatException, IOException {
		 ...
		 */
		api=baseURL+"/api/v1/transaction/?"+"status__in=D&order_by=-creation_date&api_key="+apiKey+"&username="+apiUser+"&limit="+limit;
