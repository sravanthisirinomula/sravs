...
public class DisplayPreRegisteredShips extends PTRAC_API_TestBase{
	static String api;
	Response response;
	...
	DisplayPreRegisteredShips() throws EncryptedDocumentException, InvalidFormatException, IOException {
		...
		api=baseURL+"/api/v1/transaction/?"+"status__in=E&order_by=-creation_date&api_key="+apiKey+"&username="+user+"&limit="+limit;
