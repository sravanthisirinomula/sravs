...
public class AccountLayersPage extends PTRAC_TestBase{

	public AccountLayersPage() throws IOException{
		super();
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath="//h1[contains(.,'Select account layer to change')]")
